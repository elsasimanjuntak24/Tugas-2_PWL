...
type PaymentResponse struct {
	...
	Status        string                 `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"` // Possible statuses: SUCCESS, FAILED
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_payment_proto_rawDesc = "" +
	...
	"\x0eProcessPayment\x12\x17.payment.PaymentRequest\x1a\x18.payment.PaymentResponseB\x0eZ\fgrpc/paymentb\x06proto3"
